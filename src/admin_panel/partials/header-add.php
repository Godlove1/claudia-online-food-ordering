...
<div class="text-2xl ">
<p style="font-size:2rem">SheyonceFashion</p>
</div>
...
<ul class="flex justify-end items-center name w-full h-full">
    ...
    <!-- <li class="flex justify-center items-center hover:text-teal-500 hover:bg-white bg-teal-500 transition-all ease-linear w-full p-2 border-b border-white text-white capitalize"><a href="testimony">Gallery</a></li> -->
...
<ul class="name mt-4">
    ...
    <!-- <li class="flex items-center hover:text-teal-500 hover:bg-white bg-teal-500 transition-all ease-linear w-full p-2 border-b border-white text-white capitalize"><a href="testimony" class="w-full"><i class="fa-solid fa-tags"></i> Gallery</a></li>
  -->
