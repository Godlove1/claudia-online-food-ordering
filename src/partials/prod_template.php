...
<div class="w-[200px] lg:w-[300px] aspect-video rounded-md shadow-md ">
     <a href="product?<?php echo $name ?>&hair_key=<?php echo $id; ?>" title="<?php echo $name; ?>">
      ...
      <form  method="post" class="form-item">
        <input name="product_code" type="hidden" value="<?php echo $id ?>">
...
<?php
 ...
 <p class="text-sm mb-[-440px] text-slate-400"><strike> F<?php echo number_format($price,1); ?></strike></p>
  <?php
}
           ?>
        </div>
